...
│
├── data/
│   └── pedidos_dataset.csv    # Dataset principal del proyecto
│
├── assets/
│   └── img/                   # Imágenes, capturas y recursos visuales
│
└── charts/                    # Exportaciones o archivos auxiliares de gráficos
...
Para interpretar el historial se agruparon los pedidos en tres lógicas principales:
